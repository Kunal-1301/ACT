...
const timelineItems = [
  {
    ...
    text:
      "Faculty from multiple departments began outlining the need for a shared space to work on cognition, technology, and society – collecting early ideas and use cases."
  },
  {
    title: "Core Group & Ideation Meetings",
    text:
      "A core group of faculty was formed; meetings defined themes, infrastructure requirements, and processes for funding and evaluation."
  },
  {
    title: "Formalisation of Processes",
    text:
      "Project approval flow, financial assistance guidelines, recruitment process for research staff, and evaluation matrix were drafted and refined."
  },
  {
    title: "Launch & First Calls",
    text:
      "With governance, infrastructure, and processes in place, ACT planned its first calls for proposals and pilot projects."
  }
];
...
const structureCards = [
  {
    ...
    body:
      "The centre is guided by a core leadership team that oversees strategic direction, approves calls, and monitors impact.",
  ...
  },
  {
    ...
    body:
      "A group reviews proposals using the ACT evaluation matrix, provides feedback, and may invite external experts where needed.",
    list: [
  ...
  },
  {
    ...
    body:
      "Operations teams coordinate lab access, equipment, finances, and reporting so that researchers can focus on their work.",
...
const howCards = [
  {
    ...
    text:
      "Teams start from societal questions, use ACT ideation notes and sandpit sessions to shape ideas, then prepare formal proposals using official templates.",
    link: { to: "/resources", text: "Go to Resources & Templates" }
  },
  {
    title: "Implementation & Reporting",
    text:
      "Approved projects follow the ACT implementation process – recruitment, procurement, regular check-ins, and final reporting with timesheets and documentation."
  },
  {
    title: "Impact & Public Engagement",
    text:
      "ACT encourages teams to share tools, datasets, and stories through open events, exhibitions, and outreach where appropriate."
  }
];
        ...
        <div className="container about-hero-layout">
          ...
          >
            ...
            <p className="about-hero-subtitle">
              ...
              <strong>social sciences</strong> to work on real-world questions around health,
              cognition, environment, and learning.
            </p>

            <p className="about-hero-subtitle secondary">
              A space where ideas move fluidly between labs, classrooms and
              communities — supported by shared infrastructure, structured funding,
          ...
          <aside
            ref={heroInfoRef}
            className={`about-hero-info card reveal-section ${heroInfoVisible ? "is-visible" : ""}`}
          ...
          >
            ...
            <p className="about-hero-info-text">
              ACT (Applied Cognition &amp; Technology) brings together people who care
              about how humans think, learn and act in the world — and how technology
              can be used responsibly to support them.
            </p>
        ...
        <div className="container">
          ...
          >
            <div className="about-block-header">
              <h2 id="mission-heading" className="about-block-title">Mission, Vision &amp; Values</h2>
              <p className="about-block-subtitle">
                A shared mission keeps ACT grounded even as projects and technologies evolve.
              </p>
            </div>
            ...
            <div className="about-mvv-grid">
              <article className="about-mvv-card card">
                <h3>Mission</h3>
                <p>
                  To create a collaborative environment where technology and human sciences come together to design,
                  test, and evaluate interventions that improve people’s lived experiences.
                </p>
              </article>
              ...
              <article className="about-mvv-card card">
                <h3>Vision</h3>
                <p>
                  To become a recognised hub for applied cognition and technology, where ideas move from concept to
                  prototype to real-world impact in health, education, and sustainability.
                </p>
              </article>
          ...
          <section
            id="origin"
            ref={originRef}
            className={`about-block reveal-section ${originVisible ? "is-visible" : ""}`}
            aria-labelledby="origin-heading"
          >
            <div className="about-block-header">
              <h2 id="origin-heading" className="about-block-title">How the ACT Centre Started</h2>
              <p className="about-block-subtitle">
                The centre emerged from a series of conversations, design meetings and ideation sessions that brought together faculty from different disciplines.
              </p>
            </div>
          ...
          >
            <div className="about-block-header">
              ...
              <p className="about-block-subtitle">
                Clear governance and structured processes ensure that ACT remains transparent, fair, and aligned with institutional goals.
              </p>
            </div>
            ...
            <div className="about-structure-grid">
              {structureCards.map((card, i) => (
                <article key={i} className="about-structure-card card">
                  <h3>{card.title}</h3>
                  <p>{card.body}</p>
                  {card.note && <p className="about-structure-note">{card.note}</p>}
                  {card.list && (
                    <ul>
                  ...
                  {card.link && (
                    <p className="about-structure-link">
                      <Link to={card.link.to} className="link-animated">{card.link.text}</Link>
                    </p>
                  )}
                </article>
              ))}
          ...
          >
            <div className="about-block-header">
              <h2 id="how-heading" className="about-block-title">How ACT Projects Work</h2>
              <p className="about-block-subtitle">
                ACT is intentionally process-driven so that projects remain accountable and teams get the support they need.
              </p>
            </div>
                ...
                <article key={i} className="about-how-card card">
                  ...
                  {c.link && (
                    <p className="about-how-link">
                      <Link to={c.link.to} className="link-animated">{c.link.text}</Link>
                    </p>
                  )}
                </article>
              ))}
