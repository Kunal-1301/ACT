...
function Home() {
  ...
  return (
    <div className="home-page">
      {/* 1️⃣ HERO SECTION */}
      <section className="section section--bg-tech home-hero">
        <div className="container home-hero-inner">
          ...
          <div className="home-hero-left">
            ...
            <h1 className="home-hero-title animate-in-delay-2">
              Where cognition, technology &amp; society
              <span className="home-hero-title-accent"> meet in practice.</span>
            </h1>

            <p className="home-hero-subtitle animate-in-delay-3">
              ACT is a cross–cutting centre that brings together researchers, students
              and partners to design, test and deploy human–centred technologies in
            ...
            <div className="home-hero-stats animate-in-delay-5">
              ...
              <div className="home-media-video card">
                ...
                <div className="home-media-video-body">
                  <div className="home-media-video-thumb">
                    <img
                      src="/media/act-overview-dummy.jpg"
        ...
        <div className="container home-section-header">
          ...
          <div className="home-vision-layout">
            <div className="home-vision-block card">
              ...
              <p>
                To be a leading hub where cognitive science, data, design and
                engineering converge to shape equitable, human–centred technologies
            ...
            <div className="home-vision-block card">
              ...
              <ul className="home-vision-list">
                <li>
                  Build testbeds and living labs that mirror real–world environments.
                </li>
                <li>
                  Support interdisciplinary research that links cognition, behaviour
                  and technology.
                </li>
                <li>
                  Enable students, early–career researchers and partners to pilot
        ...
        <div className="container">
          <div className="home-section-header">
            ...
            <div className="home-section-header-main">
              ...
              <p className="home-section-intro">
                The Centre anchors research around themes that sit at the intersection
                of cognition, data and infrastructure. Explore a sample of our focus
                areas below.
              </p>
            </div>
          </div>
          ...
          <div className="home-research-grid">
            <article className="card home-research-card">
              ...
              <p>
                Studying how people perceive, navigate and adapt to transport systems,
                from shared mobility to future autonomous vehicles.
              </p>
              <Link to="/research" className="link-animated">
                View mobility projects
              </Link>
            </article>
            ...
            <article className="card home-research-card">
              ...
              <p>
                Understanding attention, wayfinding, comfort and safety in complex
                buildings, campuses and public spaces.
              </p>
              <Link to="/research" className="link-animated">
                Explore environment studies
              </Link>
            </article>
            ...
            <article className="card home-research-card">
              ...
              <p>
                Designing decision aids, interfaces and workflows that keep humans in
                the loop while leveraging data and AI.
              </p>
              <Link to="/research" className="link-animated">
                See human–AI work
              </Link>
...
>
        ...
        <div className="container home-neuro-layout">
          <div className="home-neuro-left">
            ...
            <p className="home-section-intro">
              ACT is gradually building a neuroscience–informed pillar that brings
              together cognitive science, brain–behaviour measures and applied
              technology for real–world settings.
            </p>
          </div>
          <div className="home-neuro-right card">
            ...
            <ul className="home-neuro-list">
              <li>
                Incorporating cognitive load, attention and perception metrics into
                interface and system design.
              </li>
              <li>
                Exploring neuro–ergonomics in safety–critical domains like mobility,
        ...
        <div className="container">
          <div className="home-section-header">
            ...
            <div className="home-section-header-main">
              ...
              <p className="home-section-intro">
                A selection of multi–stakeholder projects that illustrate how ACT
                integrates cognitive science, data and infrastructure in practice.
              </p>
            </div>
          </div>
          ...
          <div className="home-flagship-grid">
            <article className="card home-flagship-card">
              ...
              <p>
                A living lab that studies multimodal travel behaviour, decision–making
                and information design across the TIET campus.
              </p>
              <p className="home-flagship-meta">
                In collaboration with campus planning and external mobility partners.
              </p>
            </article>
            ...
            <article className="card home-flagship-card">
              ...
              <p>
                ...
                infrastructure operations rooms to inform better tools and displays.
              </p>
              <p className="home-flagship-meta">
                Bridging human factors, data visualisation and operations research.
              </p>
            </article>
            ...
            <article className="card home-flagship-card">
              ...
              <p>
                Prototyping communication and nudging systems that respect cognitive
                limits while improving adherence and safety.
              </p>
              <p className="home-flagship-meta">
                Outputs include design guidelines, prototypes and evaluation studies.
              </p>
            </article>
          </div>
        </div>
        ...
        <div className="container">
          <div className="home-section-header home-collab-header">
            ...
            <div className="home-section-header-main">
              ...
              <p className="home-section-intro">
                ACT collaborates with academic groups, labs and organisations working
                on cognition, human factors, mobility, infrastructure and digital
          ...
          <div className="home-collab-strip card">
            <div className="home-collab-logos">
              ...
              <div className="home-collab-logo">Partner 4</div>
            </div>
            <p className="home-collab-text">
              We co–design projects, share testbeds, and host visiting researchers,
              internships and joint studios.{" "}
              <Link to="/contact" className="link-animated">
                Get in touch to explore collaboration models.
              </Link>
            </p>
          </div>
        </div>
        ...
        <div className="container">
          <div className="home-section-header">
            ...
            <div className="home-section-header-main">
              ...
              <p className="home-section-intro">
                A quick snapshot of ACT–linked funding calls. Visit the Funding page
                for full details, timelines and documents.
              </p>
            </div>
            <Link to="/funding" className="btn btn-secondary home-section-header-cta">
          ...
          <div className="home-funding-grid">
            <article className="card home-funding-card">
              ...
              <p>
                Small grants to help faculty and researchers run early–stage pilots
                linked to ACT themes and testbeds.
              </p>
            </article>
            ...
            <article className="card home-funding-card">
              ...
              <p>
                Structured fellowships for PhD and postdoctoral researchers working
                on cognition, mobility, human–AI and infrastructure.
              </p>
            </article>
            ...
            <article className="card home-funding-card">
              ...
              <p>
                Short projects co–designed with partners to demonstrate feasibility
                and generate shared evidence.
              </p>
            </article>
          </div>
        </div>
        ...
        <div className="container">
          <div className="home-section-header">
            ...
            <div className="home-section-header-main">
              ...
              <p className="home-section-intro">
                ACT is designed as a shared space. Students, scholars and staff can
                engage through projects, internships, theses and teaching activities.
              </p>
            </div>
          </div>
          ...
          <div className="home-opportunities-grid">
            ...
            <article className="card home-opportunity-card">
              ...
              <p>
                Join multi–disciplinary teams to support data collection, analysis,
                prototyping and field work.
              </p>
            ...
            <article className="card home-opportunity-card">
              ...
              <p>
                Take part in shorter formats that connect cognitive science, design,
        ...
        <div className="container">
          <div className="home-section-header home-impact-header">
            ...
            <div className="home-section-header-main">
              ...
              <p className="home-section-intro">
                Early indicators of how ACT is building a different kind of research
                and practice space within TIET.
              </p>
            </div>
          </div>
        ...
        <div className="container">
          <div className="home-section-header">
            ...
            <div className="home-section-header-main">
              ...
              <p className="home-section-intro">
                A glimpse of the faculty and researchers shaping the Centre’s agenda.
                Visit the People page for the full list of core and affiliated members.
              </p>
            </div>
            <Link to="/people" className="btn btn-secondary home-section-header-cta">
              View all people
            </Link>
          </div>
          ...
          <div className="home-people-grid">
            ...
            <article className="card home-person-card">
              ...
              <div className="home-person-body">
                ...
                <p className="home-person-meta">
                  Human factors, infrastructure systems, simulation and operations.
                </p>
              </div>
            </article>
            ...
            <article className="card home-person-card">
              ...
              <div className="home-person-body">
                ...
                <p className="home-person-meta">
                  Human–AI interaction, behavioural data, field deployments.
                </p>
              </div>
            </article>
          </div>
          ...
          <div className="home-news-events-layout">
            <div className="home-news-column">
              ...
              <article className="card home-news-card">
                ...
                <p>
                  A new testbed integrates sensors, surveys and experiments to study
                  multimodal travel on campus.
                </p>
              </article>
              ...
              <article className="card home-news-card">
                ...
                <p>
                  Researchers and practitioners discussed how perception and attention
                  shape building and campus experiences.
                </p>
              </article>

              <Link to="/news" className="link-animated home-news-more">
                View all news
              </Link>
            </div>
            ...
            <div className="home-events-column">
              ...
              <Link to="/events" className="link-animated home-news-more">
                View all events
              </Link>
            </div>
          </div>
...
>
        ...
        <div className="container home-contact-cta-inner">
          <div className="home-contact-cta-text">
            ...
            <p className="home-section-intro">
              Whether you are a student, researcher, practitioner or partner, we are
              happy to discuss how ACT can support your work.
            </p>
          </div>
